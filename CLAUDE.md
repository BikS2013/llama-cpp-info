...
## Project: llama.cpp + Gemma 4 Local Inference

### Setup

- **llama.cpp**: Cloned to `llama.cpp/` directory, built with Metal GPU support
- **Model**: Gemma 4 E2B (2.3B params, Q8_0 quantization, 4.7 GB) at `models/gemma-4-E2B/gemma-4-E2B-it-Q8_0.gguf`
- **Performance**: ~67 t/s prompt processing, ~120 t/s generation on Apple M4 Max
...
**API server:**
```bash
./llama.cpp/build/bin/llama-server -m ./models/gemma-4-E2B/gemma-4-E2B-it-Q8_0.gguf -ngl 99 --port 8080
```
...
```bash
# Example: Download Gemma 4 E4B (4.5B params)
huggingface-cli download unsloth/gemma-4-E4B-it-GGUF --include "gemma-4-E4B-it-Q8_0.gguf" --local-dir models/gemma-4-E4B
```
