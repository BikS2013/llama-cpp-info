#!/bin/bash
# download-gemma-4-31B.sh — Download Gemma 4 31B model
#
# Gemma 4 31B (dense, Q8_0, 30 GB)
#
# Usage: ./scripts/download-gemma-4-31B.sh

set -euo pipefail

PROJECT_DIR="$(cd "$(dirname "$0")/.." && pwd)"
MODELS_DIR="${PROJECT_DIR}/models"
TARGET_DIR="${MODELS_DIR}/gemma-4-31B"
HF_REPO="unsloth/gemma-4-31B-it-GGUF"
INCLUDE="gemma-4-31B-it-Q8_0.gguf"
SIZE="30 GB"

echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "Downloading Gemma 4 31B (${SIZE})"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
