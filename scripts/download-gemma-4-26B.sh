#!/bin/bash
# download-gemma-4-26B.sh — Download Gemma 4 26B model
#
# Gemma 4 26B (A4B, Q8_0, 25 GB)
#
# Usage: ./scripts/download-gemma-4-26B.sh

set -euo pipefail

PROJECT_DIR="$(cd "$(dirname "$0")/.." && pwd)"
MODELS_DIR="${PROJECT_DIR}/models"
TARGET_DIR="${MODELS_DIR}/gemma-4-26B"
HF_REPO="unsloth/gemma-4-26B-A4B-it-GGUF"
INCLUDE="gemma-4-26B-A4B-it-Q8_0.gguf"
SIZE="25 GB"

echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "Downloading Gemma 4 26B (${SIZE})"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
